...
class List_MahasiswaAdaptor (private val context: Context, private val idol: List<Inis_Variable>, val listener: (Inis_Variable) -> Unit) :
    RecyclerView.Adapter<List_MahasiswaAdaptor.ListViewHolder>() {
